 ...
 * @details Roles are hereditary, that means AdminRole is a subclass of ModeratorRole. When you grant a role to a
 * member, the less important role is replaced with the most important one. In the previous example, since the AdminRole
 * is a subclass of ModeratorRole, the AdminRole will replace the ModeratorRole instance. There are cases when you have
 ...
 * You can even extend any role or you can create a new role class in your own plugin. Just be sure that the permission
 ...
 * if you add a new permission LintPermission for the DeveloperRole, you must use the following structure (for both the
